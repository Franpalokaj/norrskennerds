...
export default function CoffeeMatch() {
  ...
  return (
    <section className="mx-auto w-full max-w-[720px] px-6 py-16">
      <hr className="mb-16 border-[#3d3b37]" />

      <h2 className="text-2xl font-bold text-[#ece8e1]">Coffee Match</h2>
      <p className="mt-3 text-base leading-relaxed text-[#c4bfb6]">
        Drop your name below and we&apos;ll match you with someone from today&apos;s
        workshop for a coffee next week. Compare systems, swap tricks, make a
        friend.
      </p>
